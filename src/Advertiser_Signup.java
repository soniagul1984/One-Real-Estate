...
/**
 * Servlet implementation class Advertiser_Signup
 */
@WebServlet("/Advertiser_Signup")
public class Advertiser_Signup extends HttpServlet {
    ...
    status = Validate.userSignup_Advertiser(user);
      if ( status == 0)
     {
    	  out.println("please enter correct information");
          RequestDispatcher rs = request.getRequestDispatcher("advertiser sign up.html");
